...
def get_config():
    ...
    parser.add_argument("--generator_batch_size", type=int, default=32)
    parser.add_argument("--generator_lr", type=float, default=1e-4)

    parser.add_argument("--outcome_lr", type=float, default=5e-4)
    parser.add_argument("--treatment_lr", type=float, default=5e-4)
    ...
    parser.add_argument("--eps_lambda", type=float, default=1.0)
    parser.add_argument("--ae_lambda_outcome", type=float, default=1e-1)
    parser.add_argument("--entropy_lambda_outcome", type=float, default=1e-1)
    parser.add_argument("--ae_lambda_treatment", type=float, default=1e-2)
